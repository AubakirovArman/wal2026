...
- 783 Python experiment/prototype scripts
- 451 result JSON files
- 596 book entries
...
- M624 compiles/inventories all 783 experiment scripts: 0 compile failures
- M625 safe runtime sweep: 259 PASS, 0 FAIL, 524 BLOCKED by policy
...
- M631 docs command smoke: 35/35 fast commands pass; 7 embedded model-small result files remain `BLOCKED`
