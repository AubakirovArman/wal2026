...
- 776 Python experiment/prototype scripts
- 444 result JSON files
- 589 book entries
...
- M624 compiles/inventories all 776 experiment scripts: 0 compile failures
- M625 safe runtime sweep: 252 PASS, 0 FAIL, 524 BLOCKED by policy
...
- M631 docs command smoke: 28/28 fast commands pass; 7 embedded model-small result files remain `BLOCKED`
