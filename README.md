...
- 799 milestone experiment scripts in `experiments/m*.py`
- 821 Python scripts total in `experiments/`
- 489 experiment result JSON files in `experiments/`
- 634 book/diary entries in `book/`
- 274 top-level result files in `results/`
- 235 docs files in `docs/`
- 5540+ lines in `docs/dev_diary_ru.md`
...
```text
experiments/        milestone scripts and result JSON for M1-M696+
