...
next block:           layer 24 has Q/K/V/O + 54.39453125% up + 0.9765625% gate + 2.63671875% down
major matrices:       11 / 197 accepted, 186 remain
major matrix weights: 70,213,632 / 1,720,451,072 = 4.081118%
...
sensitivity-ranked транзакции также приняты 54.39453125% `up_proj`, первые
0.9765625% `gate_proj` и 2.63671875% `down_proj`. Текущее покрытие
`4.081118%`, условная `+5% NLL` guide равна `1.00204056`, худший измеренный
ratio равен `1.000412`.
