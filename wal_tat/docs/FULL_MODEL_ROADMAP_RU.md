...
next block:           layer 24 has Q/K/V/O + 32.51953125% up + 0.1953125% gate + 0.48828125% down
major matrices:       11 / 197 accepted, 186 remain
major matrix weights: 67,092,480 / 1,720,451,072 = 3.899703%
...
0.1953125% `gate_proj` и 0.48828125% `down_proj`. Текущее покрытие
`3.899703%`, условная `+5% NLL` guide равна `1.00194985`, худший измеренный
...
размер с `0.390625%` до `0.1953125%` из-за небольшого audit-margin.
