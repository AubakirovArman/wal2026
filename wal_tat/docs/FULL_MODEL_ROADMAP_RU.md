...
next block:           layer 24 has Q/K/V/O + 48.14453125% up + 0.78125% gate + 1.85546875% down
major matrices:       11 / 197 accepted, 186 remain
major matrix weights: 69,304,320 / 1,720,451,072 = 4.028265%
...
0.78125% `gate_proj` и 1.85546875% `down_proj`. Текущее покрытие
`4.028265%`, условная `+5% NLL` guide равна `1.00201413`, худший измеренный
ratio равен `1.000643`.
