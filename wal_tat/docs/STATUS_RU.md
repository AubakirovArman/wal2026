...
`layer 25` полностью low-bit: после двух Q8→Q4 и четырёх Q4→Q2 шагов он
содержит `3.170268%` Q2, `16.989899%` Q4 и `79.839834%` Q8 при
`7.255188 bpw`. Всего в strict ternary переведены `1,595,648` весов.
...
На этом parent следующий атом был уменьшен до `0.25%`: 167 групп, или
`21,376` весов, прошли `7→5→3` и стали strict Q2. Fresh v8 дал
`0.995280 / 1.001836 / 1.019925`; audit-v40 —
