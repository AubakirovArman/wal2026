...
| Ternary weights | 76,673,024 (`4.456565%`) | 80,826,752 (`4.697998%`) |
| Q4-g128 weights | 0 | 71,507,072 (`4.156298%`) |
...
`layer 25` полностью low-bit: после двух Q8→Q4 и первого Q4→Q2 шага он
содержит `2.782186%` Q2, `17.377981%` Q4 и `79.839834%` Q8 при
`7.262950 bpw`. Новый Q4→Q2 шаг добавил `1,400,320` strict ternary weights.
Fresh development дал `0.995117 / 1.001547 / 1.019644`; sealed audit-v34 —
`0.993359 / 0.943748 / 0.961192`. Incremental worst равен `1.004102` против
immutable `s0053` и `1.000934` против parent, оба ниже `1.005`.
...
80,826,752 Q2-весов, 71,507,072 Q4-весов и 99,324,416 Q8-весов. Текущий
579,579,863-byte `.pt` хранит дублирующиеся int8 training arrays и не является
packed deploy-файлом. Расчётный packed payload этих low-bit весов —
151.841 MiB против 480 MiB в BF16; реальная экономия VRAM появится только
...
`model.layers.25` полностью low-bit: 1,400,320 весов используют Q2,
8,746,624 — Q4 и 40,184,704 — Q8. BF16 в семи крупных матрицах блока нет.
...
Он прошёл fresh development и sealed audit-v34. Ни Q4/Q8-веса, ни mixed
