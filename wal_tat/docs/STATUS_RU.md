...
| Ternary weights | 76,673,024 (`4.456565%`) | 81,228,672 (`4.721359%`) |
| Q4-g128 weights | 0 | 71,105,152 (`4.132937%`) |
...
`layer 25` полностью low-bit: после двух Q8→Q4 и трёх Q4→Q2 шагов он
содержит `3.127797%` Q2, `17.032369%` Q4 и `79.839834%` Q8 при
`7.256037 bpw`. Всего в strict ternary переведены `1,574,272` веса.
...
Созданный запас позволил повторить ранее не проходивший второй masked `1%`
layer-25. Через `7→5→3` переведены ещё `676` групп, или `86,528` весов.
Fresh reload дал `0.995292 / 1.001841 / 1.019975`, а одноразовый audit-v38 —
`0.997427 / 0.940653 / 0.964373`. Incremental worst равен `1.004710` против
strict source и `1.000047` против parent. Из 676 групп 675 относятся к MLP,
...
81,228,672 Q2-веса, 71,105,152 Q4-весов и 99,324,416 Q8-весов. Текущий
...
151.745 MiB против 480 MiB в BF16; реальная экономия VRAM появится только
