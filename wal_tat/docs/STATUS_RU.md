...
| Ternary weights | 76,673,024 (`4.456565%`) | 81,054,720 (`4.711248%`) |
| Q4-g128 weights | 0 | 71,279,104 (`4.143047%`) |
...
81,054,720 Q2-весов, 71,279,104 Q4-весов и 99,324,416 Q8-весов. Текущий
579,578,847-byte `.pt` хранит дублирующиеся int8 training arrays и не является
packed deploy-файлом. Расчётный packed payload этих low-bit весов —
151.787 MiB против 480 MiB в BF16; реальная экономия VRAM появится только
...
Он прошёл fresh development и sealed audit-v35. Ни Q4/Q8-веса, ни mixed
