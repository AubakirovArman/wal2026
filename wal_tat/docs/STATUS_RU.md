...
| Q4-g128 weights | 0 | 62,760,448 (`3.647907%`) |
...
79,426,432 Q2-весов, 62,760,448 Q4-весов и 59,139,712 Q8-весов. Текущий
425,023,602-byte `.pt` хранит дублирующиеся int8 training arrays и не является
packed deploy-файлом. Расчётный packed payload этих low-bit весов —
108.263 MiB против 384 MiB в BF16; реальная экономия VRAM появится только
...
Он прошёл fresh development и sealed audit-v30. Ни Q4/Q8-веса, ни mixed
