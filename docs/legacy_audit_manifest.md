...
- Total scripts: `808`
- With historical artifacts: `309`
- With `wal.results.v1` artifacts: `64`
- Current public claim allowed after audit: `52`

## Review Status Counts

- `blocked_by_policy`: `2`
- `blocked_needs_controlled_model_runner`: `388`
...
- `gpu_or_model_controlled`: `388`
- `model_small`: `7`
- `mutation_dry_run`: `37`
- `safe_core`: `7`
- `safe_core_with_artifact`: `273`
- `slow_safe`: `3`
- `subprocess_review`: `5`
