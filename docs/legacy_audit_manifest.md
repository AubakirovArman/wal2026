...
- Total scripts: `822`
- With historical artifacts: `323`
- With `wal.results.v1` artifacts: `78`
- Current public claim allowed after audit: `60`

## Review Status Counts

- `blocked_by_policy`: `2`
- `blocked_needs_controlled_model_runner`: `392`
