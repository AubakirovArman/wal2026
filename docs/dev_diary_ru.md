...
- **Результат**: total_scripts=803, parse_failures=0, runnable_scripts=275, blocked_scripts=528
- **Статус**: ✅ PASS
...
- **Результат**: total_scripts=803, executed_scripts=275, status_counts={PASS: 275, BLOCKED: 528}, FAIL=0
- **Статус**: ✅ PASS
...
- `M624/M625` policy усилен: старые public-claim generators и heavy model runners остаются `BLOCKED` в safe sweep, поэтому post-M678 sweep стал `275 PASS / 528 BLOCKED`.
...
- **Результат**: total_scripts=803, blocked_scripts=528, assigned_scripts=528, unassigned_scripts=0
- **Статус**: ✅ PASS
...
- **Результат**: run_commands=55/55 PASS, exists_only_commands=2/2 PASS, embedded_result_BLOCKED=2
- **Статус**: ✅ PASS
...
- Финальный M624 после M678 update: total_scripts=803, parse_failures=0, runnable_scripts=275, blocked_scripts=528.
...
- **Post-M678 inventory**: total_scripts=803, runnable_scripts=275, blocked_scripts=528
- **Post-M678 safe sweep**: PASS=275, BLOCKED=528, FAIL=0
...
- **Результат**: status=PASS, scripts=803, review_statuses=9, current_public_claim_allowed=47
