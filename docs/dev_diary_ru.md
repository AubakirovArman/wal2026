...
- **Результат**: total_scripts=801, parse_failures=0, runnable_scripts=273, blocked_scripts=528
- **Статус**: ✅ PASS
...
- **Результат**: total_scripts=801, executed_scripts=273, status_counts={PASS: 273, BLOCKED: 528}, FAIL=0
- **Статус**: ✅ PASS
...
- `M624/M625` policy усилен: старые public-claim generators и heavy model runners остаются `BLOCKED` в safe sweep, поэтому post-M676 sweep стал `273 PASS / 528 BLOCKED`.
...
- **Результат**: total_scripts=801, blocked_scripts=528, assigned_scripts=528, unassigned_scripts=0
- **Статус**: ✅ PASS
...
- **Результат**: run_commands=53/53 PASS, exists_only_commands=2/2 PASS, embedded_result_BLOCKED=2
- **Статус**: ✅ PASS
...
- Финальный M624 после M676 update: total_scripts=801, parse_failures=0, runnable_scripts=273, blocked_scripts=528.
...
- **Post-M676 inventory**: total_scripts=801, runnable_scripts=273, blocked_scripts=528
- **Post-M676 safe sweep**: PASS=273, BLOCKED=528, FAIL=0
