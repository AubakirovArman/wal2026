...
### Практический вывод
M669-M675 дают честный pre-alpha public release dry run. Это не alpha claim: M633 теперь `PASS` на Qwen-small, но M632/M634/M635 и M636-M638 всё ещё `BLOCKED`, M666 всё ещё `BLOCKED` без 24h runner.
