# M27 WAL SBC TUNE PROTO

## Date
2026 (exact date from git log or experiment run)

## Goal
Run and evaluate m27_wal_sbc_tune_proto.

## Configuration
See source code for full configuration.

## Method / What was tested
See `experiments/m27_wal_sbc_tune_proto.py` for implementation details.

## Result
PPL evaluation.

## Artifacts
- `experiments/m27_wal_sbc_tune_proto.py`
