#!/usr/bin/env python3
"""M43zm: Scalar DRL v2 with lmax=10, K=256 on all layers."""
import torch
...
print("Applying scalar DRL v2, lmax=10, K=256...")
...
print(f"\nScalar lmax=10 K=256 PPL (first {end_loc} tokens): {ppl.item():.2f}")
