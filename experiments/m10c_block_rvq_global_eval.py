...
L0_Q = ("model.language_model.layers.0.self_attn.q_proj",)
L0_K = ("model.language_model.layers.0.self_attn.k_proj",)
L0_V = ("model.language_model.layers.0.self_attn.v_proj",)
L0_QK = (
    "model.language_model.layers.0.self_attn.q_proj",
    "model.language_model.layers.0.self_attn.k_proj",
)
...
L54_Q = ("model.language_model.layers.54.self_attn.q_proj",)
L54_K = ("model.language_model.layers.54.self_attn.k_proj",)
L54_V = ("model.language_model.layers.54.self_attn.v_proj",)
L54_QK = L54_Q + L54_K
