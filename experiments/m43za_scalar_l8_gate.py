#!/usr/bin/env python3
"""M43za: Test scalar on layer 8 gate_proj (std=0.0728)."""
import torch
...
name = "model.language_model.layers.8.mlp.gate_proj.weight"
...
print(f"\nScalar l8 gate_proj PPL (first {end_loc} tokens): {ppl.item():.2f}")
