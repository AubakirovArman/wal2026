#!/usr/bin/env python3
"""M43y: Scalar-only with K=256 on 70B."""
import torch
...
print("Applying scalar encoder (K=256)...")
...
for name, param in list(model.named_parameters()):
    ...
    if stats["scalar"] % 50 == 0:
        print(f"  Encoded {stats['scalar']} params")
...
print(f"\nScalar K=256 PPL (first {end_loc} tokens): {ppl.item():.2f}")
