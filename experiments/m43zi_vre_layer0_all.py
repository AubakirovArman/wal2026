...
print("Applying VRE layer0 + scalar smooth + skip spiky...")
...
for name, param in list(model.named_parameters()):
    ...
    if name.startswith("model.language_model.layers.0.") and len(param.shape) == 2:
        # VRE for all layer 0 params
...
print(f"\nVRE layer0 + scalar smooth PPL (first {end_loc} tokens): {ppl.item():.2f}")
