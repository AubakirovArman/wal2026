"""
M212 — Cross-Architecture Transfer: Mistral-7B

Test if WAL works on Mistral-7B (different architecture family from Llama).
Mistral has: Sliding Window Attention, GQA, 32 layers, 4096 hidden, 14336 intermediate
"""
...
def main():
    print("=" * 60, flush=True)
    print("M212 — Cross-Architecture: Mistral-7B", flush=True)
    print("=" * 60, flush=True)
