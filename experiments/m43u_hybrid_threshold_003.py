#!/usr/bin/env python3
"""M43u: Full hybrid with threshold 0.03 (only truly spiky layers)."""
import torch
...
print("Applying hybrid encoder (threshold=0.03)...")
...
print(f"\nHybrid (thr=0.03) PPL (first {end_loc} tokens): {ppl.item():.2f}")
