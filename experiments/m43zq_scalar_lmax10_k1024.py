#!/usr/bin/env python3
"""M43zq: Scalar DRL v2 with lmax=10, K=1024 on smooth layers, skip spiky."""
import torch
...
print("Applying scalar DRL v2, lmax=10, K=1024, skip spiky...")
...
print(f"\nScalar lmax=10 K=1024 skip-spiky PPL (first {end_loc} tokens): {ppl.item():.2f}")
