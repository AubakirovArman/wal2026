...
"""
#!/usr/bin/env python3
"""M195b+ — Hadamard Adaptive K + chunked torch k-means (GPU).
...
def main():
    print("=" * 60)
    print("M195b+ — Hadamard Adaptive K + chunked torch k-means")
    print("=" * 60)
    ...
    with open('/mnt/hf_model_weights/arman/3bit/wal/experiments/m195b_plus_hadamard_adaptive_kmeans.json', 'w') as f:
