...
"""
#!/usr/bin/env python3
"""M44: Baseline PPL on 16 steps (quick gate)."""
import torch
...
out_path = RESULTS_DIR / "m44_baseline_16steps.json"
with open(out_path, "w") as f:
    json.dump(results, f, indent=2)

print(f"\nBaseline PPL ({num_steps} steps, {end_loc} tokens): {ppl.item():.4f}")
