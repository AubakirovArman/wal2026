#!/usr/bin/env python3
"""M43zt: Scalar DRL v2 with lmax=10, K=2048, skip spiky, 20 steps for accuracy."""
import torch
...
print("Applying scalar DRL v2, lmax=10, K=2048, skip spiky...")
...
print(f"\nScalar lmax=10 K=2048 skip-spiky PPL (first {end_loc} tokens, {num_steps} steps): {ppl.item():.4f}")
