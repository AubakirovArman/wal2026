...
# Which early params to skip
SKIP_EARLY = {"q_proj", "k_proj", "v_proj", "gate_proj", "up_proj"}
SKIP_LAYERS = {0, 1, 2, 3}
...
print("Applying scalar DRL v2, skip early spiky layers 0-3...")
...
for name, param in list(model.named_parameters()):
    ...
    w_hat_norm = encode_scalar_drl_batched(w_norm, ladder, L_MAX, K_TARGET)
...
print(f"\nScalar skip early spiky (layers 0-3 q/k/v/gate/up) PPL (first {end_loc} tokens): {ppl.item():.2f}")
