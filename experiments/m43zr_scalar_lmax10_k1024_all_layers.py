...
"""
#!/usr/bin/env python3
"""M43zr: Scalar DRL v2 with lmax=10, K=1024 on ALL layers (including spiky)."""
import torch
...
print("Applying scalar DRL v2, lmax=10, K=1024, ALL layers...")
...
print(f"\nScalar lmax=10 K=1024 ALL layers PPL (first {end_loc} tokens): {ppl.item():.2f}")
